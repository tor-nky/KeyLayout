...
ShiftDelay	:= 0	; 0: 通常シフト, 1以上: 後置シフトの待ち時間(ミリ秒)
CombDelay	:= 60	; 0以下: 同時押しは時間無制限
					; 1以上: シフトを押しながらで同時押しになる制限時間(ミリ秒)
...
SideShift	:= 0	; 0: 左右シフト英数, 1: 左右シフトかな
Slow		:= 0	; 0: MS-IME専用, 1: ATOK可
