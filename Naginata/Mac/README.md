...
* 薙刀式.json
* 薙刀式配列(英数編集モード付き).json —— 2020年11月6日公開までの仕様
...
Karabiner-Elements で英語系の配列より上に、一つだけ登録してください。
...
ただし、「shiftキーの応用」は「通常 shift 動作」に設定してください。
...
* 英数入力の際にも編集モードをつけていたのを、なくした。

これまでのものは、ファイル名を変えています。
